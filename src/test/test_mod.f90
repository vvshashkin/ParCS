...
subroutine topology_test()

    use topology_mod, only : init_transform_matrices, apply_transform, T_right, apply_T2_transform, change_basis, transform_index

    integer(kind=4) :: N=100
    integer(kind=4) :: is, ie, js, je, panel_number
    integer(kind=4) :: x , y, z
    integer(kind=4) :: i2, j2

    return

    call init_transform_matrices(N)
    ...
    print*, ''
    call apply_T2_transform(0, 0, panel_number, x, y, z)
    print*, x, y, z

    call apply_T2_transform(1, 0, panel_number, x, y, z)
    print*, x, y, z

    call apply_T2_transform(0, 1, panel_number, x, y, z)
    print*, x, y, z

    print*, ''
    call apply_transform(T_right, 0, 0, panel_number, x, y, z)
    print*, x, y, z

    call apply_transform(T_right, 1, 0, panel_number, x, y, z)
    print*, x, y, z

    call apply_transform(T_right, 0, 1, panel_number, x, y, z)
    print*, x, y, z

    call change_basis(ex1 = (/0, -1, 0 /), ey1 = (/-1, 0, 0/), a1 = (/100, 100 , 0/), i1=1, j1 = 1, &
                      ex2 = (/1,  0, 0 /), ey2 = (/ 0, 1, 0/), a2 = (/1, 1 , 0/), i2 = i2, j2 = j2)

    print*, i2, j2

    call transform_index(6,2, 100, 10, 100, i2, j2)
    call transform_index(6,2, 100, 10, 100, i2, j2)
    call transform_index(6,2, 100, 10, 100, i2, j2)
    call transform_index(6,2, 100, 10, 100, i2, j2)
    ...
    ! call transform_index(1,2)

end subroutine

subroutine test_exchange_profile()
...
call create_2d_cross_halo_exchange(exch, partition, 200, myid = 50, Np = 300)

end subroutine test_exchange_profile
...
call partition%init(4,1,Np/6,'default')
