...
!        vout%prex(ind)%p(is:ie,js:je,1:model_params%nz) = rhs%prex(ind)%p(is:ie,js:je,1:model_params%nz)
...
!        vout%w(ind)%p(is:ie,js:je,0:model_params%nz) = rhs%w(ind)%p(is:ie,js:je,0:model_params%nz)
!
!        vout%u(ind)%p(is-1:ie,js:je,1:model_params%nz) = 0.
!        vout%v(ind)%p(is:ie,js-1:je,1:model_params%nz) = 0.
!
