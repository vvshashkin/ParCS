...
type, extends(stvec_t) :: stvec_nh_t
    type(grid_field_t) :: u, v, w, theta, P
...
subroutine create_similar(this, destination)
    ...
    class is (stvec_nh_t)
        ...
        destination%w = this%w%create_similar()
...
subroutine assign_s1v1s2v2(this, scalar1, v1, scalar2, v2, domain)
    ...
    class is (stvec_nh_t)
        ...
        class is (stvec_nh_t)
            ...
            call this%w%assign(scalar1, v1%w, scalar2, v2%w, domain%mesh_w)
...
subroutine update_s1v1s2v2(this, scalar1, v1, scalar2, v2, domain)
    ...
    class is (stvec_nh_t)
        ...
        class is (stvec_nh_t)
            ...
            call this%w%update(scalar1, v1%w, scalar2, v2%w, domain%mesh_w)
...
subroutine update_s1v1(this, scalar1, v1, domain)
    ...
    class is (stvec_nh_t)
        ...
        call this%w%update(scalar1, v1%w, domain%mesh_w)
