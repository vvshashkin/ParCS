...
subroutine parse(this, config_string)
    ...
    real(kind=8) :: simulation_time_days, simulation_time_hours, &
                    simulation_time_min, simulation_time_sec
    ...
    simulation_time_days  = 0.0_8
    simulation_time_hours = 0.0_8
    simulation_time_min   = 0.0_8
    simulation_time_sec   = 0.0_8
