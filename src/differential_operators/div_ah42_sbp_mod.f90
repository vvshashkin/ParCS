...
type, public, extends(div_operator_t) :: div_ah42_sbp_t
    class(exchange_t), allocatable     :: exch_uv_interior
    class(exchange_t), allocatable     :: exch_div_edges
contains
    procedure, public :: calc_div => calc_div_ah42_sbp
end type div_ah42_sbp_t

contains

subroutine calc_div_ah42_sbp(this, div, u, v, domain, multiplier)
    class(div_ah42_sbp_t),  intent(inout) :: this
...
end subroutine calc_div_ah42_sbp
...
subroutine calc_div_on_tile(div, u, v, mesh, multiplier)
    ...
    do k = ks, ke
        ...
        call sbp_diff("y","d42",Gv,v%is,v%ie,v%js,v%je,mesh%ny+1,is,ie,js,je,Dy)
        ...
        call sbp_diff("x","d42",Gu,u%is,u%ie,u%js,u%je,mesh%nx+1,is,ie,js,je,Dx)
