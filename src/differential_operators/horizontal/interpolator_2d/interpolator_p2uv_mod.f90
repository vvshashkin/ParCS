...
! type, public, extends(interpolator2d_scalar2vec_t) :: interpolator_p2uv_sbp_Ch_t
!     class(exchange_t),     allocatable :: exchange_Ah
!     class(sbp_operator_t), allocatable :: sbp_interp_p2uv
! contains
!     procedure, public :: interp_p2uv => interp_p2uv_Ch
! end type interpolator_p2uv_sbp_Ch_t
...
! subroutine interp_p2uv_Ah_C(this, u, v, u_h, v_h, domain)
!
!     class(interpolator_p2uv_sbp_t), intent(inout) :: this
...
!
!     do t = domain%partition%ts, domain%partition%te
!         call interp_p2uv_tile(u%tile(t), v%tile(t), u_h%tile(t), v_h%tile(t), &
!                     this%sbp_interp_p2uv, domain%mesh_y%tile(t), &
!                     domain%mesh_x%tile(t), domain%mesh_p%tile(t))
!     end do
!
! end subroutine interp_p2uv_Ah_C
