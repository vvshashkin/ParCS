...
subroutine create_vertical_operator(vertical_op, vertical_op_name)
    ...
    case("vertical_grad_staggered_sbp21")
        call create_sbp_vertical_op(vertical_op, "D21_staggered_c2i","n")
    case("vertical_grad_staggered_sbp42")
        call create_sbp_vertical_op(vertical_op, "D42_staggered_c2i","n")
    case("vertical_grad_sbp21")
        call create_sbp_vertical_op(vertical_op, "d21","n")
    case("vertical_grad_sbp42")
        call create_sbp_vertical_op(vertical_op, "d42","n")
    case("vertical_grad_sbp63")
        call create_sbp_vertical_op(vertical_op, "d63","n")
    case("vertical_div_staggered_sbp21")
        call create_sbp_vertical_op(vertical_op, "D21_staggered_i2c","p")
    case("vertical_div_staggered_sbp42")
        call create_sbp_vertical_op(vertical_op, "D42_staggered_i2c","p")
    case default
...
subroutine create_sbp_vertical_op(vertical_op, sbp_op_name, target_grid_name)
