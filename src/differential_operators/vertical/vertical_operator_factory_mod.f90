...
subroutine create_vertical_operator(vertical_op, vertical_op_name)
    ...
    case("eta_diff_p2w_sbp21")
        call create_sbp_vertical_op(vertical_op, "D21_staggered_c2i","w")
    case("eta_diff_p2w_sbp42")
        call create_sbp_vertical_op(vertical_op, "D42_staggered_c2i","w")
    case("eta_diff_sbp21")
        call create_sbp_vertical_op(vertical_op, "d21","w")
    case("eta_diff_sbp42")
        call create_sbp_vertical_op(vertical_op, "d42","w")
    case("eta_diff_sbp63")
        call create_sbp_vertical_op(vertical_op, "d63","w")
